...
export declare type IconTemplate = string | ((iconOpts?: {
    width?: number;
    height?: number;
}) => TemplateResult | string);
export declare type ControlButtonCallbackDispatchFunction<E extends StarboardEventName> = (name: E, detail: StarboardEventInitDict<StarboardEventMap[E]>) => boolean;
